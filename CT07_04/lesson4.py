...
# while True:
#     ans = input("what countries would you like to visit? ")
#     if ans == "end":
#         break
...
while True:
    food = input("what food items would you like to add? ")
    if food == "end":
        break

    menu.append(food)

print("this is your restaurant menu:")
for item in menu:
    print(item)
...
if order in menu:
    ...
    print("sorry, please go to the next door")    
